  ...
  return (
    <form action={action} className="flex flex-wrap items-center gap-2">
      ...
      <button
        type="submit"
        disabled={pending}
        className={status === "active" ? "inline-flex h-8 items-center gap-1 rounded-lg bg-rose-50 px-2.5 text-xs font-medium text-rose-700 ring-1 ring-rose-200 transition hover:bg-rose-100 disabled:opacity-60" : "inline-flex h-8 items-center gap-1 rounded-lg bg-emerald-50 px-2.5 text-xs font-medium text-emerald-700 ring-1 ring-emerald-200 transition hover:bg-emerald-100 disabled:opacity-60"}
      >
