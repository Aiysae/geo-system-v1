...
export const MEMBERSHIP_LEVELS: readonly MembershipLevelDefinition[] = [
  {
    ...
    teamMemberLimit: 0,
    title: "正式会员",
    benefits: ["解锁自定义公司名称与 Logo 的白标报告", "保留充值、积分与报告历史记录", "可创建 1 枚 Agent 密钥"],
  },
  {
    tier: "vip2",
    minPaidCents: 10_000,
    ...
    teamMemberLimit: 0,
    title: "客户服务版",
    benefits: ["包含 VIP1 全部权益", "可创建 1 个客户专属账号", "Agent 密钥上限提升至 2 枚"],
  },
  {
    tier: "vip3",
    minPaidCents: 60_000,
    ...
    teamMemberLimit: 0,
    title: "多客户服务版",
    benefits: ["包含 VIP2 全部权益", "可创建 3 个客户专属账号", "关键词策略疑问句可由 AI 裁判自动分配模板并批量成文", "Agent 密钥上限提升至 5 枚"],
  },
  {
    tier: "vip4",
    ...
    teamMemberLimit: 5,
    title: "业务增长版",
    benefits: ["包含 VIP3 全部权益", "可创建 10 个客户专属账号", "创建团队并邀请 5 名协作成员", "可创建 10 枚 Agent 密钥并授权团队客户"],
  },
  {
    tier: "vip5",
    ...
    teamMemberLimit: 15,
    title: "机构运营版",
    benefits: ["包含 VIP4 全部权益", "可创建 30 个客户专属账号", "团队成员上限提升至 15 人", "Agent 密钥上限提升至 20 枚"],
  },
  {
    tier: "vip6",
    ...
    teamMemberLimit: 50,
    title: "企业规模版",
    benefits: ["包含 VIP5 全部权益", "可创建 100 个客户专属账号", "团队成员上限提升至 50 人", "Agent 密钥上限提升至 50 枚"],
  },
] as const
