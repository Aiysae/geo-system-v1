  ...
  return {
    ...
    result: {
      ...
      dimensions: Object.fromEntries([
        ["行业竞争与头部封锁", 12, 15, "头部品牌已经建立较稳定的模型提及和信源结构。"],
        ["目标品牌可见度差距", 11, 15, "目标品牌已有一定可见度，但跨模型表现仍不均衡。"],
        ["信任资产差距", 12, 15, "需要多类权威资产与可读取链接共同支撑。"],
        ["内容矩阵缺口", 10, 15, "高质量问题覆盖和持续更新需要稳定产能。"],
        ["地域覆盖与本地资源差距", 11, 15, "全国覆盖的总工作量高于单城市，同时要兼顾本地资源建设。"],
        ["商业预算竞争压力", 14, 15, "高客单与高毛利会吸引更多专业团队投入竞争。"],
        ["AI 答案进入门槛", 8, 10, "进入推荐答案需要稳定的可验证信源和持续的内容供给。"],
      ...
      process: {
        ...
        scoring: stage("七维评分", "结合竞争、可见度、信任、内容、地域、商业压力和 AI 答案门槛评分。"),
